      ...
      <div className="form-spring" style={{
        ...
        <div style={{ display: 'flex', gap: '6px' }}>
          <button onClick={saveEdit} style={{
            ...
            fontSize: '11px', fontWeight: 700, transition: 'all 0.2s var(--ease-spring)',
          }}>Guardar</button>
          <button onClick={cancelEdit} style={{
            padding: '7px 12px', borderRadius: '8px',
            border: '1px solid var(--border)', color: 'var(--cream-muted)',
            fontSize: '11px', transition: 'all 0.2s var(--ease-spring)',
          }}>Cancelar</button>
        </div>
      </div>
    );
    ...
    return (
      <div className="form-spring" style={{
        ...
        <div style={{ display: 'flex', gap: '6px' }}>
          <button onClick={saveEdit} style={{
            flex: 1, padding: '7px', borderRadius: '8px',
            background: editType === 'income' ? 'var(--sage)' : 'var(--coral)',
            color: 'var(--obsidian)', fontSize: '11px', fontWeight: 700,
            transition: 'all 0.2s var(--ease-spring)',
          }}>Guardar</button>
          <button onClick={cancelEdit} style={{
            padding: '7px 12px', borderRadius: '8px',
